...
const Engagement = () => {
  return (
    <section className="bg-white px-6 py-16 sm:px-10 lg:px-16">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 lg:grid-cols-[1.3fr_1fr] lg:gap-12">
        {/* Left column */}
        <div>
        ...
        <div className="rounded-2xl border border-indigo-200 bg-gradient-to-b from-indigo-50/40 to-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-500">
            ...
            processes, and tools. The vendor handles employment, payroll, HR
            compliance, and replacement SLA. Your sprint board doesn't
