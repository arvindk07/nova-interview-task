    ...
    <div className="border-b border-white/15">
      ...
      >
        ...
        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-white/25">
          ...
          <img src={ChevronDown} alt="Toggle"  className={`text-blue-300 transition-transform duration-200 ${
              isOpen ? "rotate-180" : ""
            }`}/>
        </span>
      </button>
...
const HowItWorks = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#0a1450] via-[#0d1a5c] to-[#1e3fa8] px-6 py-16 sm:px-10 lg:px-16">
      {/* Decorative shapes */}
      <div className="pointer-events-none absolute bottom-0 left-0 h-56 w-72 opacity-40">
        <div className="absolute bottom-0 left-0 h-40 w-40 rounded-full bg-white/5" />
        <div className="absolute bottom-0 left-16 h-48 w-32 rotate-12 bg-white/5" />
        <div className="absolute -bottom-6 left-0 h-24 w-24 rounded-full bg-blue-500/20" />
      </div>
      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-blue-100/80">
            Your engineering process stays the same. The only thing that
            changes is who joins your team. You manage delivery. We handle
            employment, HR, and replacements while engineers work inside your
            existing workflows.
          </p>
        </div>
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-blue-100/80">
            ...
            matched to your stack - Java/Spring Boot,{" "}
